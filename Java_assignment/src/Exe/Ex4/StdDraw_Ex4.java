...
public final class StdDraw_Ex4 implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
	...
	private static void init() {
		if (getFrame() != null) getFrame().setVisible(false);
		setFrame(new JFrame());
		...
		getFrame().setContentPane(draw);
		getFrame().addKeyListener(std);    // JLabel cannot get keyboard focus
	...
	private static JMenuBar createMenuBar() {
		...
		menuItem1.addActionListener(std);
		menu.add(menuItem1);
		menuItem1 = new JMenuItem("All");
		menuItem1.addActionListener(std);
		menu.add(menuItem1);
		menuItem1 = new JMenuItem("Anti");
		menuItem1.addActionListener(std);
		menu.add(menuItem1);
		menuItem1 = new JMenuItem("None");
		menuItem1.addActionListener(std);
		menu.add(menuItem1);
		...
		menu.add(menuItem1);
		menuItem1.addActionListener(std);
		menuItem1 = new JMenuItem("Triangle");
		menuItem1.addActionListener(std);
		menu.add(menuItem1);
		menuItem1 = new JMenuItem("Polygon");
		menuItem1.addActionListener(std);
		menu.add(menuItem1);
		
		menu = new JMenu("Sort");
		menuBar.add(menu);
		menuItem1 = new JMenuItem("ByArea");
		menuItem1.addActionListener(std);
		menu.add(menuItem1);
		menuItem1 = new JMenuItem("ByAntiArea");
		menuItem1.addActionListener(std);
		menu.add(menuItem1);
		menuItem1 = new JMenuItem("ByPerimeter");
		menuItem1.addActionListener(std);
		menu.add(menuItem1);
		menuItem1 = new JMenuItem("ByAntiPerimeter");
		menuItem1.addActionListener(std);
		menu.add(menuItem1);
		menuItem1 = new JMenuItem("ByToString");
		menuItem1.addActionListener(std);
		menu.add(menuItem1);
		menuItem1 = new JMenuItem("ByAntiToString");
		menuItem1.addActionListener(std);
		menu.add(menuItem1);
		menuItem1 = new JMenuItem("ByTag");
		menuItem1.addActionListener(std);
		menu.add(menuItem1);
		menuItem1 = new JMenuItem("ByAntiTag");
		menuItem1.addActionListener(std);
		menu.add(menuItem1);
		
		menu = new JMenu("Edit");
		menuBar.add(menu);
		menuItem1 = new JMenuItem("Move");
		menuItem1.addActionListener(std);
		menu.add(menuItem1);
		menuItem1 = new JMenuItem("Copy");
		menuItem1.addActionListener(std);
		menu.add(menuItem1);
		menuItem1 = new JMenuItem("Remove");
		menuItem1.addActionListener(std);
		menu.add(menuItem1);
		menuItem1 = new JMenuItem("Rotate");
		menuItem1.addActionListener(std);
		menu.add(menuItem1);
		menuItem1 = new JMenuItem("Scale_90%");
		menuItem1.addActionListener(std);
		menu.add(menuItem1);
		menuItem1 = new JMenuItem("Scale_110%");
		menuItem1.addActionListener(std);
		menu.add(menuItem1);
	...
	public void mousePressed(MouseEvent e) {
		synchronized (mouseLock) {
			...
			if(b==1) {
				_ex4.mouseClicked(new Point2D(mouseX, mouseY));
			}
			if(b==3) {
				_ex4.mouseRightClicked(new Point2D(mouseX, mouseY));
			}
